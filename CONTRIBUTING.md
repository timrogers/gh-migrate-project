...
1. Seed the GHES instance with data. You can do this by running `npm run configure-github-enterprise-server-instance -- --ghes-base-url <base-url> --ghes-access-token <access-token>`, replacing the arguments as appropriate.
